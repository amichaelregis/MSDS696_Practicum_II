...
Title of Project : Analyse Fedeal funding Impact on Broadband Equity
...
data_folder = Path("/Users/amalmichael/2026/MSDS/696 Practicum II/Week7/Data/FCC")
...
csv_path = '/Users/amalmichael/2026/MSDS/696 Practicum II/Week7/Data/RDOF/auction904_updated_cbg.csv'
...
# Define File Paths
income_path = '/Users/amalmichael/2026/MSDS/696 Practicum II/Week7/Data/CensusIncome/national_blockgroup_median_income.csv'
...
minority_path = '/Users/amalmichael/2026/MSDS/696 Practicum II/Week7/Data/CensusMinorityPct/national_blockgroup_minority_pct.csv'
...
for col in numeric_cols:
    ...
    if max_val > p75 * 5: # Flagging if max is 5x higher than 75th percentile
        print(f"  ⚠️  Column '{col}' has potential extreme outliers (Max: {max_val:,.2f}, 75th%: {p75:,.2f})")
...
# %% Step 8.d: Final Efficiency Heatmap (Large Professional Fonts)
import pandas as pd
import seaborn as sns
import matplotlib.pyplot as plt
...
shp_path = '/Users/amalmichael/2026/MSDS/696 Practicum II/Week7/Data/ShapeFiles/national_blockgroup.shp'
...
base_path = '/Users/amalmichael/2026/MSDS/696 Practicum II/Week7/'
...
# Export A: GeoJSON
print(f"Exporting GeoJSON to {base_path}...")
geojson_path = base_path + 'national_broadband_final_map.geojson'
map_data.to_file(geojson_path, driver='GeoJSON')

# Export B: Spatial CSV (WKT)
print(f"Exporting Spatial CSV to {base_path}...")
wkt_path = base_path + 'national_broadband_spatial_tableau.csv'
...
print(f"\n Pipeline Complete! Files saved to: {base_path}")

# Export C: Diagnostic Review CSV (Flat file for QA)
print(f"Exporting Diagnostic Review CSV to {base_path}...")
review_csv_path = base_path + 'national_policy_diagnostic_review.csv'
